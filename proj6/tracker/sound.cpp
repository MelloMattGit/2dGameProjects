  ...
  channels()
{
  ...
  if (!music) throw string("Couldn't load music.wav ")+Mix_GetError();
  startMusic();
  sounds.push_back(Mix_LoadWAV("sounds/explosion.wav"));
  sounds.push_back(Mix_LoadWAV("sounds/whirlwind.wav"));
  sounds.push_back(Mix_LoadWAV("sounds/pidgeot.wav"));
